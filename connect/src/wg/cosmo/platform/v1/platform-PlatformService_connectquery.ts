 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOperationsPage
 */
export const getOperationsPage = {
  localName: "getOperationsPage",
  name: "GetOperationsPage",
  kind: MethodKind.Unary,
  I: GetOperationsPageRequest,
  O: GetOperationsPageResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOperationDetailMetricsPage
 */
export const getOperationDetailMetricsPage = {
  localName: "getOperationDetailMetricsPage",
  name: "GetOperationDetailMetricsPage",
  kind: MethodKind.Unary,
  I: GetOperationDetailMetricsPageRequest,
  O: GetOperationDetailMetricsPageResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOperationDetailClientPage
 */
export const getOperationDetailClientPage = {
  localName: "getOperationDetailClientPage",
  name: "GetOperationDetailClientPage",
  kind: MethodKind.Unary,
  I: GetOperationDetailClientPageRequest,
  O: GetOperationDetailClientPageResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
